...
import '../database/DBFunction.dart';
    ...
    if(mail != ""&& pwd !=""){
      if(emailvalidation==true){
        ...
        if(isUserFound == true){
          ...
          Get.snackbar("Error", "Please provide a valid email",colorText: Colors.red);
        }

      }else{
        Get.snackbar("Error", "Password length should be greater than 6",colorText: Colors.red);
      }
    }
